...
if ($_POST) {
  ...
  if ($first_no < $second_no && $first_no < $third_no) {
    $msg= "$first_no is min number";
  } elseif ($second_no < $first_no && $second_no < $third_no) {
    $msg= "$second_no is min number";
  } elseif ($third_no < $first_no && $third_no < $second_no) {
    $msg= "$third_no is min number";
  } else {
    $msg= "error";
  }
}
...
<body>
  <h1 style="text-align: center">Min Number</h1>
  <form action="" method="post" style="text-align: center">
    <h5 style="text-align: center">first number</h5>
    <input type="text" name="first_no">
    <br>
    <br>
    <h5 style="text-align: center">second number</h5>
    <input type="text" name="second_no">
    <br>
    <br>
    <h5 style="text-align: center">third number</h5>
